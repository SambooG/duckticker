...
Also, with this visual it keeps things interesting and are hopes are that it will encourage people to have more of an interest in the stock market overall.</p>
        <img src="../assets/images/logo2.jpg" class="float-left" alt="Paris" width="304" height="100%" />
        <img src="../assets/images/logo.jpg" class="float-right" alt="Paris" width="304" height="100%" />
      </div>
    </div>
